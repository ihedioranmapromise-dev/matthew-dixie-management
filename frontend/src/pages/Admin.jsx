...
const Admin = () => {
  ...
  useEffect(() => {
    const fetchAll = async () => {
      await Promise.all([fetchApplications(), fetchTiers(), fetchUsers(), fetchSupportInfo(), fetchPressContent()]);
      setLoading(false);
    };
    fetchAll();
  }, []);
  ...
  return (
    <div className="min-h-screen bg-charcoal text-white pt-20 px-6">
      <div className="max-w-7xl mx-auto">
        ...
        <p className="text-warm-sand-light opacity-70 mb-8">Manage applications, tiers, users, and content</p>
